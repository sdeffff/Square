...
const SectionHeader: React.FC<Props> = (props) => {
    ...
    return (
        <div className="relative border-x-2 border-grey15">
            ...
            <article className="absolute flex flex-col gap-0 sm:px-2 xl:w-[66rem] md:w-full text-[#fff] text-center top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 overflow-hidden">
                ...
                <p className="barlow-light w-96 text-sm md:w-full md:text-base lg:text-[1.1rem]">{props.txt}</p>
            </article>
        </div>
    )
}
