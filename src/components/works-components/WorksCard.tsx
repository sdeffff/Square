...
const WorksCard = (props: Props) => {
    return (
        <li className="border-x-[0.5px] border-t-[0.5px] border-grey15 px-12 pb-24 h-[48rem] border-b-[0.5px] ">
            <h1 className="text-grey60 text-[1.3rem] barlow-medium py-7">{props.title}</h1>
