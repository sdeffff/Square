    ...
    return (
        <ul className="bg:flex w-full items-center border border-grey15">
            ...
            <Card img={engineering}
                    title="Engineering"
                    txt="Our engineering team combines technical expertise with a passion for innovation to build robust and scalable digital solutions. We leverage the latest technologies and best practices to deliver high-performance applications tailored to your specific needs." />
            <Card img={pm}
