...
const ThanksMain = () => {
    ...
    return (
        <section className="thanks-section border-x-2 border-grey15 py-4 2xl:mx-32 xl:mx-32 xl:px-16 xl:py-14 lg:py-10 tb:py-5 tb:mx-16 tb:px-14">
            <form className="text-white flex flex-col gap-10 px-2 tb:px-0" onClick={handleSubmit} ref={formRef}>
                <ul className="info flex flex-col md:flex-row justify-between">
                    <li className="barlow-medium flex flex-col gap-3 py-4 px-7 2xl:w-96 xl:w-[22rem] tb:w-80">
                    ...
                    <li className="barlow-medium flex flex-col gap-3 py-4 px-9 2xl:w-96 xl:w-[22rem] tb:w-80">
                ...
                <div className="contacting flex flex-col gap-8 p-5 tb:p-7">
                    <h2 className="barlow-medium text-lg tb:text-xl lg:text-2xl leading-normal">Why are you contacting us?</h2>
